        ...
        <div className="w-full h-full flex justify-center items-center backdrop-brightness-50 ">
          <div className="text-center">
            ...
            <div className="h-[4rem] bg-gradient-to-br from-red-600 via-pink-800 to-purple-900 rounded-full flex justify-start items-center p-2 md:w-[60rem]">
              <input className="h-[100%] w-[70%] text-start rounded-full outline-none border-none md:w-[80%] text-md p-2" type="text" placeholder="Search ..."  onChange={(e)=>setSearchString(e.target.value)}/>
